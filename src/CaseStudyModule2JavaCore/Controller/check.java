...
//
//    }
    public ArrayList<T> getFileCSVtoList(){
        BufferedReader br = null;
        ArrayList<T> List_element = new ArrayList<>();
        try {
            String line;
            br = new BufferedReader(new FileReader(root_links));

            while ((line = br.readLine()) != null){
                String[] splitData = line.split(",");
                if (splitData[0].equals("HEADER")){
                    continue;
                }
            }
    ...
    public void showInfomationService() {
        for (T element:getFileCSVtoList()){
